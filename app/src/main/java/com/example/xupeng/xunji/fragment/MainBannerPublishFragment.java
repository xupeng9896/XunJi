...
public class MainBannerPublishFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.main_banner_article_fragment,container,false);
    ...
    private void initView(View view){
        mImage=(ImageView)view.findViewById(R.id.main_banner_image);
        mTitleET=(MyEditText)view.findViewById(R.id.main_banner_title);
        mContentET=(MyEditText)view.findViewById(R.id.main_banner_content);
        mPublishBtn=(Button)view.findViewById(R.id.main_banner_publish);
        ...
        mPublishBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                List<MainBannerItem> itemList= DataSupport.findAll(MainBannerItem.class);
                int count=itemList.size();
                MainBannerItem item=new MainBannerItem();
                item.setArticleId("b"+count);
