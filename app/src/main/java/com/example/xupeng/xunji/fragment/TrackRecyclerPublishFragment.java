...
public class TrackRecyclerPublishFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.track_recycler_article_fragment,container,false);
    ...
    private void initView(View view){
        mImage=(ImageView)view.findViewById(R.id.track_rv_image);
        mTitleET=(MyEditText)view.findViewById(R.id.track_rv_title);
        //mContentET=(MyEditText)view.findViewById(R.id.track_rv_content);
        mPublishBtn=(Button)view.findViewById(R.id.track_rv_publish);
        ...
        mPublishBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                List<SearchTrackRecyclerItem> itemList=DataSupport.findAll(SearchTrackRecyclerItem.class);
                int count=itemList.size();
                SearchTrackRecyclerItem item=new SearchTrackRecyclerItem();
                item.setArticleId("t"+count);
                ...
                myApplication.setPublishIndex(3);
            }
        });
    }
